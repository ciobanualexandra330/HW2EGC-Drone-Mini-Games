...
void Lab6::Init()
{
    ...
    // Create a shader program for drawing face polygon with the color of the normal
    {
        ...
        std::cout << "Location model matrix: " << glGetUniformLocation(shaders["LabShader"]->program, "model") << std::endl;
        std::cout << "Location view matrix: " << glGetUniformLocation(shaders["LabShader"]->program, "view") << std::endl;
        std::cout << "Location projection matrix: " << glGetUniformLocation(shaders["LabShader"]->program, "projection") << std::endl;
